...
import kotlinx.android.synthetic.main.fragment_your_journeys.*
...
open class YourJourneysFragment : HomeFragment() {
    ...
    private fun initToolbar() {
        toolbar.setStartIcon(R.drawable.ic_menu).setTitle(getString(R.string.toolbar_title_your_journeys))
